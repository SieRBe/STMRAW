...
const unsigned long sendInterval = 600000;  // Kirim setiap 10 menit (600000 ms)
...
void setup() {
  ...
  Serial.println("\n========== ESP32: READY ==========");
  Serial.println("Mengirim data ke STM32 setiap 10 menit");
...
void loop() {
  ...
  // Kirim data setiap sendInterval (10 menit)
